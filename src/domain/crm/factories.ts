...
export function createCompany(partial: Partial<Company> = {}): Company {
  ...
  return {
    ...
    annualRevenue: partial.annualRevenue ?? { amount: 250000000, currency: "EUR" },
...
export function createLead(partial: Partial<Lead> = {}): Lead {
  ...
  return {
    ...
    estimatedValue: partial.estimatedValue ?? { amount: 150000, currency: "EUR" },
...
export function createOpportunity(partial: Partial<Opportunity> = {}): Opportunity {
  ...
  return {
    ...
    amount: partial.amount ?? { amount: 200000, currency: "EUR" },
...
export function createDeal(partial: Partial<Deal> = {}): Deal {
  ...
  return {
    ...
    amount: partial.amount ?? { amount: 250000, currency: "EUR" },
