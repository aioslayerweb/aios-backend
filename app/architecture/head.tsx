export default function Head() {
  return (
    <>
      ...
      />
      <meta property="og:title" content="AIOS Architecture | Enterprise Intelligence Layers" />
      <meta
      ...
      <meta name="twitter:title" content="AIOS Architecture | Enterprise Intelligence Layers" />
      <meta
